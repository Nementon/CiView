    ...
    public class GraphCanvas : Panel
    {
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            foreach (UIElement child in InternalChildren)
            {
                ...
                topLeft.X = Math.Min(topLeft.X, left - halfWidth - Origin.X);
                topLeft.Y = Math.Min(topLeft.Y, top - halfHeight - Origin.Y);

                //calculate the bottom right corner point
                bottomRight.X = Math.Max(bottomRight.X, left + halfWidth - Origin.X);
                bottomRight.Y = Math.Max(bottomRight.Y, top + halfHeight - Origin.Y);
            }
        ...
        /// <summary>
        /// Gets or sets the virtual origin of the canvas.
        /// </summary>
        public Point Origin
        {
        ...
        public static readonly DependencyProperty OriginProperty =
            DependencyProperty.Register("Origin", typeof(Point), typeof(GraphCanvas),
