...
namespace GraphSharp.Controls
{
    ...
    public static class GraphElementBehavior
    {
        ...
        {
            UIElement e = d as UIElement;
            if (e != null) e.RemoveHandler(UnhighlightEvent, handler);
        }
        ...
        {
            UIElement e = d as UIElement;
            if (e != null) e.AddHandler(HighlightTriggeredEvent, handler);
        }

        public static void RemoveHighlightTriggeredHandler(DependencyObject d, RoutedEventHandler handler)
        {
            UIElement e = d as UIElement;
            if (e != null) e.RemoveHandler(HighlightTriggeredEvent, handler);
        }
        ...
        {
            UIElement e = d as UIElement;
            if (e != null) e.AddHandler(HighlightInfoChangedEvent, handler);
        }

        public static void RemoveHighlightInfoChangedHandler(DependencyObject d, RoutedEventHandler handler)
        {
            UIElement e = d as UIElement;
            if (e != null) e.RemoveHandler(HighlightInfoChangedEvent, handler);
        }
        ...
        public static readonly DependencyProperty HighlightTriggerProperty =
            DependencyProperty.RegisterAttached("HighlightTrigger", typeof(bool), typeof(GraphElementBehavior), new UIPropertyMetadata(false, null, HighlightTrigger_Coerce));
        ...
        private static readonly DependencyPropertyKey IsHighlightedPropertyKey =
            DependencyProperty.RegisterAttachedReadOnly("IsHighlighted", typeof(bool), typeof(GraphElementBehavior), new UIPropertyMetadata(false, IsHighlighted_PropertyChanged));
